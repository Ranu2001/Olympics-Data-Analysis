...
if user_menu == 'Overall Analysis':
    ...
    fig = px.line(events_over_time, x='Year', y="Number of Events")
    st.plotly_chart(fig)
...
if user_menu == 'Athlete wise Analysis':
    ...
    fig = ff.create_distplot([x1, x2, x3, x4],["Overall Analysis", "Gold Medalist", "Silver Medalist", "Bronze Medalist"],
    ...
    fig, ax = plt.subplots()
    ax = sns.ax = sns.scatterplot(data=temp_df, x='Weight', y='Height', hue='Medal', style='Sex', s=60)
    st.pyplot(fig)
